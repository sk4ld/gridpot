...
void switch_object::set_switch_full_reliability(unsigned char desired_status)
{
    ...
    //output_debug("set_switch_full_reliability: before A:%x, B:%x, C:%x",phase_A_state,phase_B_state,phase_C_state);
    ...
    //output_debug("set_switch_full_reliability: after A:%x, B:%x, C:%x",phase_A_state,phase_B_state,phase_C_state);
}
