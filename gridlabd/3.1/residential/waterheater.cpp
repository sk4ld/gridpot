...
int waterheater::init(OBJECT *parent)
{
	...
	// Warning users about demand property being linked to the water heater power demand now.
	gl_warning("Water heater 'demand' property has been deprecated. Please, use 'water_demand'instead. See ticket #798 for details.");
